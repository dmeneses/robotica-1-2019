...
public class CarritoDibujar {
	...
	public static void main(String[] args) {
		...
		EV3LargeRegulatedMotor rueda1 = new EV3LargeRegulatedMotor(MotorPort.A);
		EV3LargeRegulatedMotor rueda2 = new EV3LargeRegulatedMotor(MotorPort.B);
		EV3LargeRegulatedMotor lapiz = new EV3LargeRegulatedMotor(MotorPort.C);
