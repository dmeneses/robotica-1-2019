...
public class PruebaCarrito {
	...
	public static void main(String[] args) {
		...
		Carrito carritoOli = new Carrito();
		...
		while(hayColor == false){			
			colorDetectado = carritoOli.dectectarColor();
		...
		double distanciaAvance = 30; // 100 cm
 		if (colorDetectado == colorAzul){
 		...
 		for(int piso = 0; piso < 3; piso = piso + 1) {
 			...
 			carritoOli.girar(grado);
 			carritoOli.avanzar(distanciaAvance);
 		}
